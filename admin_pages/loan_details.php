...
/* Specific colors */
.badge-pending { background-color: #f0ad4e; }   /* Orange */
.badge-paid { background-color: #28a745; }      /* Green */
.badge-overdue { background-color: #dc3545; }   /* Red */
    ...
    <div class="row g-4">
        ...
        <div class="col-12 col-md-8">
            ...
            <div class="content-card mb-4">
                ...
                <div class="info-row"> <!-- Use same structure for all rows -->
                    <div class="row">
                    ...
                    <table class="table table-hover">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
<span class="badge-payment badge-<?php echo $payment['status']; ?>">
    <?php echo ucfirst($payment['status']); ?>
                ...
                <div class="d-md-none">
                    ...
                    <div class="card mb-2 shadow-sm">
                        <div class="card-body p-3">
                            ...
                            <div class="mt-1"><small class="text-muted">Amount</small><div>₱<?php echo number_format($payment['amount'],2); ?></div></div>
                            <?php if(isAdmin()): ?>
        ...
        <div class="col-12 col-md-4 d-flex flex-column gap-3">
            <!-- Loan Summary -->
            <div class="summary-box mb-3 flex-shrink-0">
